...
/**
 * Performance test for the Coordinator entity.
 */
class CoordinatorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Coordinator entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all coordinators")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created coordinator")
                .get("${new_coordinator_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created coordinator")
            .delete("${new_coordinator_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
